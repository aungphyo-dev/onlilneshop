...
let aTag = document.querySelectorAll(".Add");
...
let adsmodel = document.querySelector(".adsmodel");
for(let i=0;i<PRODUCTS.length;i++){
        let galleryDiv = document.createElement("div");
        galleryDiv.classList.add('gallery');
        let adslink = document.createElement("a");
        galleryDiv.appendChild(adslink);
        let adsImage = document.createElement('img');
        adsImage.src=PRODUCTS[i].image;
        adslink.appendChild(adsImage);
        let ContentDiv= document.createElement('div');
        ContentDiv.classList.add('desc');
        galleryDiv.appendChild(ContentDiv);
        let AdsTitle = document.createElement('h4');
        AdsTitle.innerText=PRODUCTS[i].title;
        ContentDiv.appendChild(AdsTitle);
        let AdsPrice = document.createElement('h5');
        AdsPrice.classList.add('h5color');
        let $icon = document.createElement('i');
        ContentDiv.appendChild($icon);
        $icon.classList.add('fa-solid' , 'fa-dollar-sign');
        AdsPrice.innerText=PRODUCTS[i].price;
        ContentDiv.appendChild(AdsPrice);
        let AdsRating = document.createElement('p');
        ContentDiv.appendChild(AdsRating);
        // AdsRating.innerText=PRODUCTS[i].rating.rate;
        let RatingStar1 = document.createElement('i');
        RatingStar1.classList.add('fa-solid' , 'fa-star','compare1');
        AdsRating.appendChild(RatingStar1);
        let RatingStar2 = document.createElement('i');
        RatingStar2.classList.add('fa-solid' , 'fa-star','compare2');
        AdsRating.appendChild(RatingStar2);
        let RatingStar3 = document.createElement('i');
        RatingStar3.classList.add('fa-solid' , 'fa-star','compare3');
        AdsRating.appendChild(RatingStar3);
        let RatingStar4 = document.createElement('i');
        RatingStar4.classList.add('fa-solid' , 'fa-star','compare4');
        AdsRating.appendChild(RatingStar4);
        let RatingStar5 = document.createElement('i');
        RatingStar5.classList.add('fa-solid' , 'fa-star' ,'compare5');
        AdsRating.appendChild(RatingStar5);
        
        
        adsmodel.appendChild(galleryDiv); 
}
...
for(let i=0;i<PRODUCTS2.length;i++){
  ...
  galleryDiv.appendChild(adslink);
  let adsImage = document.createElement('img');
  adsImage.src=PRODUCTS2[i].thumbnail;
  adslink.appendChild(adsImage);
  let ContentDiv= document.createElement('div');
  ContentDiv.classList.add('desc');
  galleryDiv.appendChild(ContentDiv);
  let AdsTitle = document.createElement('h4');
  AdsTitle.innerText=PRODUCTS2[i].title;
  ContentDiv.appendChild(AdsTitle);
  let AdsPrice = document.createElement('h5');
  AdsPrice.classList.add('h5color');
  let $icon = document.createElement('i');
  ContentDiv.appendChild($icon);
  $icon.classList.add('fa-solid' , 'fa-dollar-sign');
  AdsPrice.innerText=PRODUCTS2[i].price;
  ContentDiv.appendChild(AdsPrice);
  let AdsRating = document.createElement('p');
  ContentDiv.appendChild(AdsRating);
  // AdsRating.innerText=PRODUCTS[i].rating.rate;
  let RatingStar1 = document.createElement('i');
  RatingStar1.classList.add('fa-solid' , 'fa-star');
  AdsRating.appendChild(RatingStar1);
  let RatingStar2 = document.createElement('i');
  RatingStar2.classList.add('fa-solid' , 'fa-star');
  AdsRating.appendChild(RatingStar2);
  let RatingStar3 = document.createElement('i');
  RatingStar3.classList.add('fa-solid' , 'fa-star');
  AdsRating.appendChild(RatingStar3);
  let RatingStar4 = document.createElement('i');
  RatingStar4.classList.add('fa-solid' , 'fa-star');
  AdsRating.appendChild(RatingStar4);
  let RatingStar5 = document.createElement('i');
  RatingStar5.classList.add('fa-solid' , 'fa-star');
  AdsRating.appendChild(RatingStar5);
...
let IMG=document.querySelector(".adsimage");
let img_array=["https://icms-image.slatic.net/images/ims-web/57ba250d-339e-4cf7-9425-516d2ea84a05.jpg",
"https://icms-image.slatic.net/images/ims-web/c58f58ec-4e4d-4552-a158-0e320a8f54c3.jpg_1200x1200.jpg",
"https://icms-image.slatic.net/images/ims-web/618101e8-ad4f-4d09-b6fd-6a44aba9092e.jpg",
"https://icms-image.slatic.net/images/ims-web/924af140-e844-46a2-8307-e772f3b419f7.jpg",
"https://icms-image.slatic.net/images/ims-web/66ad7191-2624-45d7-b402-2e0fa2ea0f80.png",
"https://icms-image.slatic.net/images/ims-web/5ad5244c-f7cb-476a-b2bc-d7551dab0246.jpg",
"https://icms-image.slatic.net/images/ims-web/45c4ea07-1ac4-4232-955b-17538fafa5ec.jpg",
"https://icms-image.slatic.net/images/ims-web/01dbe23a-459d-4149-9edf-017dd6e937a0.jpg",];
let index=0;
function slide(){
